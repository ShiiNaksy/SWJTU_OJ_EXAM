...
class ExamResults(Base):
	...
	id = Column(Integer, primary_key=True, autoincrement=True)
	exam_id = Column(Integer, ForeignKey('exams.id'))
	stu_id = Column(Integer, ForeignKey('users.stu_id'))
	answers = Column(String(8192))
	judged = Column(Integer) # True or False
...
class Judgement(Base):
	...
	judged = Column(Integer, default=0) # False
	right = Column(Integer, default=0) # not right
